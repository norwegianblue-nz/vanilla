 ...
 * @return mixed
 */
function plingcom2_return_clean_breakpoint_id(\Drupal\breakpoint\Breakpoint $breakpoint) {
 ...
 */
function plingcom2_return_layouts($theme) {
 ...
 * @return int|string
 */
function plingcom2_find_layout_provider($theme) {
 ...
 */
function plingcom2_return_active_layout() {
  ...
  $layoutProvider = plingcom2_find_layout_provider($theme);
  //dpm($layoutProvider);
