 ...
 * @return mixed
 */
function krtk0_return_clean_breakpoint_id(\Drupal\breakpoint\Breakpoint $breakpoint) {
 ...
 */
function krtk0_return_layouts($theme) {
 ...
 * @return int|string
 */
function krtk0_find_layout_provider($theme) {
 ...
 */
function krtk0_return_active_layout() {
  ...
  $layoutProvider = krtk0_find_layout_provider($theme);
  //dpm($layoutProvider);
