 ...
 * @return mixed
 */
function parrot-stripes_return_clean_breakpoint_id(\Drupal\breakpoint\Breakpoint $breakpoint) {
 ...
 */
function parrot-stripes_return_layouts($theme) {
 ...
 * @return int|string
 */
function parrot-stripes_find_layout_provider($theme) {
 ...
 */
function parrot-stripes_return_active_layout() {
