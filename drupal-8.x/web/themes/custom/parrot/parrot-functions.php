 ...
 * @return mixed
 */
function parrot_return_clean_breakpoint_id(\Drupal\breakpoint\Breakpoint $breakpoint) {
 ...
 */
function parrot_return_layouts($theme) {
 ...
 * @return int|string
 */
function parrot_find_layout_provider($theme) {
 ...
 */
function parrot_return_active_layout() {
  ...
  $layoutProvider = parrot_find_layout_provider($theme);
  //dpm($layoutProvider);
